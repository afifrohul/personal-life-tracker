...
interface TablePersonalTaskProps {
    paginationData: Pagination<PersonalTask>;
    filters: {
        search: string;
        status: string;
        priority: string;
...
export default function TablePersonalTask({
    paginationData,
    filters,
}: TablePersonalTaskProps) {
    ...
    const columns: ColumnDef<typeof features, PersonalTask>[] = [
        {
            id: 'number',
            header: '#',
            cell: ({ row }) =>
        ...
        <div className="flex flex-col gap-4 rounded-md border p-4">
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <Button
                        size="sm"
                        onClick={() => router.get('/personal-tasks/create')}
                    >
