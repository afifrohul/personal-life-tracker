...
interface TableFlowcashCategoryProps {
    paginationData: Pagination<FlowcashCategory>;
    filters: {
        search: string;
        perPage: number;
    };
...
export default function TableFlowcashCategory({
    paginationData,
    filters,
}: TableFlowcashCategoryProps) {
    ...
    const columns: ColumnDef<typeof features, FlowcashCategory>[] = [
        {
            id: 'number',
            header: '#',
            cell: ({ row }) =>
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <Button
                        size="sm"
                        onClick={() =>
                            router.get('/flowcash-categories/create')
                        }
                    >
